package com.osia.ampirux.service.barber.impl
...
class BarberServiceImpl(
    ...
    @Transactional(readOnly = true)
    override fun getById(id: UUID): Barber {
    ...
    @Transactional(readOnly = true)
    override fun findByMultiple(idList: List<UUID>): List<BarberDto> {
    ...
    @Transactional(readOnly = true)
    override fun findAll(pageable: Pageable): Page<BarberDto> {
        log.trace("findAll -> pageable: $pageable")
        return repository.findAll(Specification.where(CreateSpec<Barber>().createSpec("")), pageable).map(mapper::toDto)
    }

    @Transactional(readOnly = true)
    override fun findAllByFilter(pageable: Pageable, where: String): Page<BarberDto> {
        log.trace("findAllByFilter -> pageable: $pageable, where: $where")
        return repository.findAll(Specification.where(CreateSpec<Barber>().createSpec(where)), pageable).map(mapper::toDto)
    }

    @Transactional
    override fun save(request: BarberRequest, replace: Boolean): BarberDto {
    ...
    @Transactional
    override fun saveMultiple(requestList: List<BarberRequest>): List<BarberDto> {
    ...
    @Transactional
    override fun update(id: UUID, request: BarberRequest, includeDelete: Boolean): BarberDto {
    ...
    @Transactional
    override fun updateMultiple(dtoList: List<BarberDto>): List<BarberDto> {
