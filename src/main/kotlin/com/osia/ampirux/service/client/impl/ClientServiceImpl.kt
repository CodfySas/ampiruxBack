package com.osia.ampirux.service.client.impl
...
class ClientServiceImpl(
    ...
    private val mapper: BaseMapper<ClientRequest, Client, ClientDto>,
    ...
    @Transactional(readOnly = true)
    override fun findByMultiple(idList: List<UUID>): List<ClientDto> {
    ...
    override fun findAll(pageable: Pageable): Page<ClientDto> {
        ...
        return repository.findAll(Specification.where(CreateSpec<Client>().createSpec("")), pageable).map(mapper::toDto)
    }
    ...
    override fun findAllByFilter(pageable: Pageable, where: String): Page<ClientDto> {
        ...
        return repository.findAll(Specification.where(CreateSpec<Client>().createSpec(where)), pageable).map(mapper::toDto)
    }

    @Transactional
    override fun save(request: ClientRequest, replace: Boolean): ClientDto {
    ...
    @Transactional
    override fun saveMultiple(requestList: List<ClientRequest>): List<ClientDto> {
    ...
    @Transactional
    override fun update(id: UUID, request: ClientRequest, includeDelete: Boolean): ClientDto {
    ...
    @Transactional
    override fun updateMultiple(dtoList: List<ClientDto>): List<ClientDto> {
