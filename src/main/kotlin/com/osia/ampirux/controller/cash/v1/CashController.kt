...
class CashController(
    ...
    fun findAllByFilter(pageable: Pageable, @PathVariable where: String): Page< CashDto> {
    ...
    @PostMapping
    fun save(@Validated(OnCreate::class) request: CashRequest): ResponseEntity<CashDto > {
        return ResponseEntity(service.save(request), HttpStatus.CREATED)
    }

    @PostMapping("/multiple")
    fun saveMultiple(@Validated(OnCreate::class) requestList: List< CashRequest>): ResponseEntity<List<CashDto > > {
