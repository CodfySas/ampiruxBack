...
class MessageController(
    ...
    fun findAllByFilter(pageable: Pageable, @PathVariable where: String): Page<MessageDto> {
    ...
    @PostMapping
    fun save(@Validated(OnCreate::class) request: MessageRequest): ResponseEntity<MessageDto> {
        return ResponseEntity(service.save(request), HttpStatus.CREATED)
    }

    @PostMapping("/multiple")
    fun saveMultiple(@Validated(OnCreate::class) requestList: List<MessageRequest>): ResponseEntity<List<MessageDto>> {
